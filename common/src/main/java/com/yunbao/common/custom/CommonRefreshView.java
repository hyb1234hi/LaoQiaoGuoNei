...
public class CommonRefreshView extends FrameLayout implements View.OnClickListener {
    ...
    private boolean mEmptyEnable;//是否显示空数据
    ...
    public CommonRefreshView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyEnable = ta.getBoolean(R.styleable.CommonRefreshView_crv_emptyEnable, true);
        ...
        public void onSuccess(int code, String msg, String[] info) {
            ...
            if (info != null) {
                ...
                if (mDataCount > 0) {
                    ...
                    adapter.clearData();
                    if (mEmptyEnable && mEmptyLayout != null && mEmptyLayout.getVisibility() != View.VISIBLE) {
    ...
    public void setEmptyLayoutId(int noDataLayoutId) {
        if (mEmptyEnable && mEmptyLayout != null) {
