...
public class Constants {
    ...
    public static final int LIVE_FUNC_OPEN_GOODS = 2009;//开启商品
    public static final int LIVE_FUNC_COUPON = 2010;//优惠券
    ...
    public static final String SOCKET_SHOP = "SendShop";//主播PK
    ...
    public static final int SHOP_TYPE = 0;//商品
    public static final int COUPON_TYPE = 1;//优惠券
