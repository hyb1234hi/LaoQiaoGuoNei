...
public class MainHomeLiveAdapter extends RefreshAdapter<LiveBean>implements RefreshView.DataAdapter<LiveBean> {
    ...
    @Override
    public void appendData(List<LiveBean> data) {
       mList.addAll(data);
       notifyDataSetChanged();
    }

    @Override
    public List<LiveBean> getArray() {
        return mList;
    }
