...
public class LiveUserDialogFragment extends AbsDialogFragment implements View.OnClickListener {
    ...
    private DialogUitl.StringArrayDialogCallback mArrayDialogCallback = new DialogUitl.StringArrayDialogCallback() {
        ...
        public void onItemClick(String text, int tag) {
            ...
            } else if (tag == R.string.live_setting_gap) {
                setShutUp();
    ...
    private void setShutUp() {
        LiveHttpUtil.setShutUp(mLiveUid, mToUid, new HttpCallback() {
            @Override
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0) {
    ...
    private void closeLive() {
        dismiss();
        LiveHttpUtil.superCloseRoom(mLiveUid, false, mSuperCloseRoomCallback);
    }
    ...
    private void forbidAccount() {
        dismiss();
        LiveHttpUtil.superCloseRoom(mLiveUid, true, mSuperCloseRoomCallback);
    }
