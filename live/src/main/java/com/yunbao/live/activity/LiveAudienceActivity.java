        ...
        LiveHttpUtil.enterRoom(mLiveUid, mStream, new HttpCallback() {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0 && info.length > 0) {
                    ...
                    String shoplink= obj.getString("shoplink");
                    String  shopimg= obj.getString("shopimg");

                    int shopstatus= obj.getIntValue("shopstatus");
                    int isopencoupon= obj.getIntValue("isopencoupon");


                    String shopid= obj.getString("shopid");

                    mLiveRoomViewHolder.setShopLinked(shopstatus==1,shoplink,shopimg);
                    mLiveRoomViewHolder.setShopId(shopid);

                    mLiveRoomViewHolder.setClickable(isopencoupon,city,false);
                }
            }
        });
    }
