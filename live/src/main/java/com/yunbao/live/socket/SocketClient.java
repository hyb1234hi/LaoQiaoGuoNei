...
import static com.yunbao.common.Constants.SHOP_TYPE;
        ...
        private void processBroadcast(String socketMsg) {
            ...
            switch (map.getString("_method_")) {
                ...
                case Constants.SOCKET_GAME_EBB://游戏 二八贝
                    ...
                    break;
                case Constants.SOCKET_SHOP://购物
                    int isopen= Integer.parseInt(map.getString("isopen"));
                    int type =Integer.parseInt(map.getString("iscoupon"));
                    ...
                    if(type==SHOP_TYPE){
                        if(isopen==1){
                            ...
                            String  imagelink= map.getString("imagelink");
                            liveLinkEntity.setLink(link);
                            liveLinkEntity.setFilelink(imagelink);
                            liveLinkEntity.setShopId(map.getString("shopid"));
                        }

                    mListener.shop(type,isopen,liveLinkEntity);

                    }else{
                        mListener.coupon(isopen,city);
                    }
                    break;
            }
        }
