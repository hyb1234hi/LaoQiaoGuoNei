...
public class LiveFunctionAdapter extends RecyclerView.Adapter<LiveFunctionAdapter.Vh> {
    ...
    public LiveFunctionAdapter(Context context, boolean hasGame) {
        ...
        mList.add(new LiveFunctionBean(Constants.LIVE_FUNC_OPEN_GOODS, R.mipmap.icon_goods, R.string.open_goods));
        mList.add(new LiveFunctionBean(Constants.LIVE_FUNC_COUPON, R.mipmap.icon_coupon, R.string.live_coupon));
