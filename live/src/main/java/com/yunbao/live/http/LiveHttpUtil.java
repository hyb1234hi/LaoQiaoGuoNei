...
public class LiveHttpUtil {
    ...
    /**
     * 广告页或者banner页 1广告2banner
     */
    public static void SlideGetSlideList(String slide_cid, HttpCallback callback) {
        HttpClient.getInstance().get("Slide.GetSlideList", LiveHttpConsts.LINK_MIC_TX_MIX_STREAM)
                .params("slide_cid", slide_cid)
                .execute(callback);
    }
}
